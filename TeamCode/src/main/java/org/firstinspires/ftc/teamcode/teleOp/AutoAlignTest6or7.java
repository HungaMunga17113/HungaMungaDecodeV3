...
public class AutoAlignTest6or7 extends OpMode {
    ...
    public static Pose startingPose = new Pose(30.379736408566725, 77.0608072487644, Math.toRadians(180)); //See ExampleAuto to understand how to use this
    ...
    public void loop() {
        ...
        turnTowards =  85+Math.toDegrees(angle);
        if (!automatedDrive) {
